  ...
  if (isLoading) {
    return (
      <div className="flex h-screen items-center justify-center">
        <img src="/logo.png" alt="Logo" className="h-16 w-16 rounded-2xl shadow-xl animate-pulse" />
      </div>
    );
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-gradient-to-br from-violet-600 via-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center text-white px-8">
          <div className="mx-auto mb-6">
            <img src="/logo.png" alt="Logo" className="h-20 w-20 rounded-2xl shadow-2xl mx-auto" />
          </div>
          <h1 className="text-4xl font-bold mb-4">Sovereign Brainstorming Platform</h1>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-6">
          <div className="lg:hidden flex items-center gap-2 justify-center mb-8">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-teal-600 via-cyan-600 to-indigo-600 bg-clip-text text-transparent">
              Brainstorm
            </span>
          </div>
          {children}
