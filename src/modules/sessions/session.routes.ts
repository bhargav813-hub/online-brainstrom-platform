...
import { requireMembership, requireBoardMembership, requireSessionMembership, requireSessionRole, requireBoardOwnerOrFacilitator, requireSessionFacilitatorOrAdmin } from '../../middleware/rbac.middleware';
...
router.put('/:sessionId', requireSessionFacilitatorOrAdmin, validate(updateSessionSchema), SessionController.update);
...
router.post('/:sessionId/invite', requireSessionFacilitatorOrAdmin, validate(inviteToSessionSchema), SessionController.invite);
